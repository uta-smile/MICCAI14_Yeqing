...
basepath = fullfile('.', 'RetinalData', 'separate');
obj = {'seq1','seq2','seq3','seq4','seq5'};
inputdir = fullfile(basepath, [obj{i} '\']);
outputdir = fullfile(basepath, '\');
...
outfn = fullfile(opt.output, sprintf('tld_%s_%s.txt', obj{i}, timestamp));
dlmwrite(outfn,[bb; conf]');
disp(['Results saved to ' outfn]);